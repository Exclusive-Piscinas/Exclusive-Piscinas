...
const QuoteCart = ({ cartItems, onUpdateQuantity, onRemoveItem, onClearCart }: QuoteCartProps) => {
  ...
  const handleSubmitQuote = async () => {
    ...
    const { data, error } = await createQuote(quoteData);
  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button className="btn-primary fixed bottom-6 right-6 z-50 rounded-full p-4 shadow-elegant">
