          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                {product.featured && (
                  <Badge className="bg-gradient-accent text-accent-foreground px-3 py-1 shadow-glow">
            ...
            <Tabs defaultValue="description" className="w-full">
              <TabsList className="grid w-full grid-cols-3 bg-card/50 border border-border/30 p-1 rounded-xl">
                <TabsTrigger 
                  value="description" 
                  className="data-[state=active]:bg-gradient-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-elegant rounded-lg transition-all duration-300"
                >
                  Descrição
                </TabsTrigger>
                <TabsTrigger 
                  ...
                  <div className="prose prose-invert max-w-none">
                    {product.description ? (
                      <div 
                        ...
                        className="text-foreground leading-relaxed [&_p]:text-foreground [&_h1]:text-foreground [&_h2]:text-foreground [&_h3]:text-foreground [&_h4]:text-foreground [&_h5]:text-foreground [&_h6]:text-foreground [&_strong]:text-accent [&_em]:text-accent-glow"
                      />
                    ) : (
                      <p className="text-muted-foreground text-center py-8">Descrição não disponível para este produto.</p>
                    )}
                  </div>
                </div>
              </TabsContent>
                  ...
                  {product.features && product.features.length > 0 ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {product.features.map((feature, index) => (
                        <div key={index} className="flex items-center gap-3 p-3 bg-card/30 rounded-lg border border-border/20">
                    ...
                    <p className="text-muted-foreground text-center py-8">Nenhuma característica disponível para este produto.</p>
                  )}
                </div>
              </TabsContent>
                    ...
                    <div className="space-y-4">
                      {productAccessories.map((accessory) => {
                        ...
                        return (
                          <Card 
                            key={accessory.id} 
                            className={`transition-all duration-300 border border-border/30 ${
                              isSelected 
                                ? 'ring-2 ring-accent shadow-glow bg-gradient-card' 
                                : 'hover:border-accent/50 bg-card/50'
                            }`}
                          >
